...
opciones = {
    1: calcular_area_triangulo,
    2: calcular_area_cuadrado,
    3: calcular_area_hexagono,
    4: calcular_area_pentagono,
    5: calcular_area_circulo
}

print("Seleccione una opción:")
print("1.Calcular el área de un triángulo equilátero ")
print("2.Calcular el área de un cuadrado ")
print("3. Calcular el área de un hexagono regular")
print("4. Calcular el área de un pentagono regular")
...
if opcion in opciones:
    ...
    print("Opción inválida. Se calculará el área como la de un círculo.")
